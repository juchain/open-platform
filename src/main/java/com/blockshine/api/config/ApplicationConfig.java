...
package com.blockshine.api.config;
...
import com.blockshine.api.util.exception.Web3jSafeAnnotationsErrorResolver;

/**
 * Created by Stan Reshetnyk on 18.07.16.
 */
@Configuration
@ComponentScan("com.blockshine")
@MapperScan("com.blockshine.*.dao")
