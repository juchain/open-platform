...
import com.ethercamp.harmony.dto.BShineRequest;
...
//        String beforeJumpDest = substringBefore(asm, "JUMPDEST");
    ...
    public BShineResponse queryContractAddress(String txHash) throws Exception {
    		com.ethercamp.harmony.jsonrpc.TransactionReceiptDTO receipt = jspnRpc.eth_getTransactionReceipt(txHash);
    ...
    public BShineResponse invokeContract(InvokeContractRequest request) throws Exception {
        ...
        transArgu.data = com.ethercamp.harmony.jsonrpc.TypeConverter.toJsonHex(functionCallBytes);
